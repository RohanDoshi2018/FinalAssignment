...
\begin{tabular}{c c c}
\textbf{Variable} & \textbf{Meaning} & \textbf{Feature Importance Coefficient} \\ 
	\hline
	\texttt{UGDS\_AIAN} & Prop. of UGs with American Indian Heritage & 3.66 $\cdot \text{ }10^9$ \\
	\texttt{UGDS\_ASIAN} & Prop. of UGs with Asian Heritage & 3.60 $\cdot \text{ }10^9$  \\ 
	\texttt{UGDS\_2MOR} & Prop. of UGs with Mixed Heritage & 3.52 $\cdot \text{ }10^9$ \\
	\texttt{UGDS\_BLACK} & Prop. of UGs with Black Heritage & 3.49 $\cdot \text{ }10^9$ \\
	\texttt{UGDS\_UNKN} & Prop. of UGs with Unknown Heritage  & 3.47 $\cdot \text{ }10^9$ \\
	\texttt{UGDS\_NHPI} & Prop. of UGs with Pacific Islander Heritage & 3.47 $\cdot \text{ }10^9$ \\
	\texttt{UGDS\_HISP} & Prop. of UGs with Hispanic Heritage & 3.42 $\cdot \text{ }10^9$ \\
	\texttt{UGDS\_NRA} & Prop. of UGs who are Non\-Resident Aliens & 3.41 $\cdot \text{ }10^9$ \\
	\texttt{UGDS\_WHITE} & Prop. of UGs with Caucasian Heritage & 3.39 $\cdot \text{ }10^9$ \\
	\texttt{PCIP29} & \% of Degrees in Military Tech/Applied Sciences &  1.22 $\cdot \text{ }10^9$ \\
	\texttt{NOPELL\_ENRL\_ORIG\_YR6\_RT} & \% without Pell Still Enrolled After 6 Years & 8.08 $\cdot \text{ }10^8$ \\
	\texttt{PCIP41} & \% of Degrees in Science Technologies & 5.37 $\cdot \text{ }10^8$ 
\end{tabular}
